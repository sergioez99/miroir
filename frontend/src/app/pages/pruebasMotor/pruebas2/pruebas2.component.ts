...
export class Pruebas2Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.cam = this.motor.crearCamara(null, [0,0,25], [0,7*pi/4,0], [1,1,1], 0.1, 100, 0, 0, 0, 0, 0);
    this.luz = this.motor.crearLuz(null, [0,25,0], [3*pi/2,0,0], [1,1,1], [1,1,1], "puntual", 1, 1, 1, 1, 1);
    ...
    this.sombrero = this.motor.crearModelo(this.personaje, [0,10,0], [0,0,pi/8], [1,1,1], "hat.blend");
